...
namespace itemlist
{
    ...
    const auto weapons =
    {
        ...
        "HandGun_Default|Handgun(Common)",
        "HandGun_Default_2|Handgun(Uncommon)",
        "HandGun_Default_3|Handgun(Rare)",
        "HandGun_Default_4|Handgun(Epic)",
        "HandGun_Default_5|Handgun(Legendary)",
    ...
    const auto palskill =
    {
        ...
        "SkillUnlock_BirdDragon|Vanywrm Saddle",
